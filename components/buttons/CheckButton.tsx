...
export default function CheckButton({ href }: CheckButtonProps) {
  return (
    <button
      ...
      class="bg-gradient-to-r from-green-400 to-green-500 text-white px-3 py-1 rounded hover:from-green-400 hover:to-green-600 transition-colors duration-300"
    >
